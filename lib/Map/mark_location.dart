...
class mark_location extends StatefulWidget {
  const mark_location({Key? key}) : super(key: key);

  @override
  State<mark_location> createState() => _mark_locationState();
}

class _mark_locationState extends State<mark_location> {
  String result = "";
  String lat = "";
  String lng = "";
